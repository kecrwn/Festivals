...
export function celebrationVisual(record: FestivalRecord) {
  ...
  if (record.kind === "National" || record.kind === "Special" || record.kind === "Cultural") return { src: "https://images.pexels.com/photos/1181406/pexels-photo-1181406.jpeg?auto=compress&cs=tinysrgb&w=1600", alt: { id: "Suasana kegiatan bersama sebagai visual koleksi", en: "A shared public moment as a collection visual" } };
  if (record.kind === "Sikh" || record.kind === "Buddhist" || record.kind === "Jain" || record.kind === "Confucian") return { src: "https://images.pexels.com/photos/37526113/pexels-photo-37526113/free-photo-of-traditional-balinese-canang-sari-offerings.jpeg?auto=compress&cs=tinysrgb&w=1600", alt: { id: "Bunga dan bahan alami sebagai visual koleksi", en: "Flowers and natural materials as a collection visual" } };
  return { src: "https://images.pexels.com/photos/13689170/pexels-photo-13689170.jpeg?auto=compress&cs=tinysrgb&w=1600", alt: { id: "Cahaya dan warna sebagai visual koleksi", en: "Light and colour as a collection visual" } };
}
