...
export function celebrationVisual(record: FestivalRecord) {
  ...
  if (id.includes("raksha")) return { src: "https://images.pexels.com/photos/13689170/pexels-photo-13689170.jpeg?auto=compress&cs=tinysrgb&w=1600", alt: { id: "Cahaya dan wadah kecil sebagai visual koleksi", en: "Light and small vessels as a collection visual" }, material: { id: "OBJEK ATLAS · BENANG RAKHI & WADAH UPACARA", en: "ATLAS OBJECT · RAKHI THREAD & CEREMONIAL VESSEL" } };
